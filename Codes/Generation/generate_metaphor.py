        ...
        input=[
            {
                ...
                * Replace one or more literal expressions with metaphorical language that conveys the same underlying meaning.
                * The metaphor should arise naturally from the situation (e.g., walls, storms, battles, knives, bridges, fires, weights, chains, doors).
